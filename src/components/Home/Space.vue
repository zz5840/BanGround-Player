<template>
	<div>
		<q-input :label="$t('home.space.bpm')" type="number" v-model="bpm"/>
		<q-input :label="$t('home.space.offset')" type="number" v-model="offset"/>
		<i18n class="q-mt-md" path="home.space.result" tag="p">
